...
class CreateClientWindow(Toplevel, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Label(frame1, text="DNI (2 ints y 1 upper char)").grid(row=0, column=0)
        Label(frame1, text="Nombre (de 2 a 30 chars)").grid(row=0, column=1)
        Label(frame1, text="Apellido (de 2 a 30 chars)").grid(row=0, column=2)
        ...
        crear = Button(frame2, text="Crear", command=self.create_client)
...
class EditClientWindow(Toplevel, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Label(frame1, text="DNI (no editable)").grid(row=0, column=0)
        Label(frame1, text="Nombre (de 2 a 30 chars)").grid(row=0, column=1)
        Label(frame1, text="Apellido (de 2 a 30 chars)").grid(row=0, column=2)
        ...
        actualizar = Button(frame2, text="Actualizar", command=self.edit_client)
    ...
    def edit_client(self):
        self.master.treeview.item(self.dni.get(), values=(self.dni.get(), self.nombre.get(), self.apellido.get()))
...
class MainWindow(Tk, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Button(frame2, text="Crear", command=self.create).grid(row=0, column=0)
        Button(frame2, text="Modificar", command=self.edit).grid(row=0, column=1)
        Button(frame2, text="Borrar", command=self.delete).grid(row=0, column=2)
